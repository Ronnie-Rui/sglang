...
class TestHiSparseDsaBackendPolicy(unittest.TestCase):
    ...
    def test_quest_runtime_accepts_disabled_kernel_options(self):
        boolean_options = (
            "use_triton_score_kernel",
            "use_fused_score_mask_kernel",
            "enable_cuda_graph_retrieval",
        ...
        for option in boolean_options:
            self.assertIs(config.sparse_extra_config[option], False)

    def test_quest_runtime_accepts_native_page_bounds_dtype(self):
        server_args = ServerArgs(
            model_path="dummy",
            enable_hisparse=True,
            disable_radix_cache=True,
        ...
        self.assertIs(config.sparse_extra_config["use_native_page_bounds_dtype"], True)
